      ...
      <div className="about-me-content">
        ...
        <div className="about-left">
          ...
          <ul className="contact-info">
            <li>
              <i class="fa-solid fa-map"></i> D.K. Nivas, Green Park
            </li>
            <li>
              <i class="fa-solid fa-phone"></i> +91 6291599419
            </li>
            <li>
              <i class="fa-solid fa-envelope"></i> aryaa111000@gmail.com
            </li>
            <li>
              <i class="fa-solid fa-computer"></i> www.yourwebsite.com
            </li>
          </ul>
        </div>
